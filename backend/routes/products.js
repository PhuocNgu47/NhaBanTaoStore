 ...
 */
router.post('/', protect, authorize('admin', 'owner', 'staff'), activityLogger, productController.createProduct);

/**
 * PUT /api/products/:id
 * Cập nhật thông tin sản phẩm (Admin only)
 */
router.put('/:id', protect, authorize('admin', 'owner', 'staff'), activityLogger, productController.updateProduct);

/**
 * DELETE /api/products/:id
 * Xóa sản phẩm (Admin only)
 */
router.delete('/:id', protect, authorize('admin', 'owner'), activityLogger, productController.deleteProduct);
